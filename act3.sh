# 1. Unload the Millenium Falcon in ONE COMMAND!add
...
mv han_solo star_wars/rebellion/millenium_falcon
mv luke_skywalker star_wars/rebellion/millenium_falcon
mv chewy star_wars/rebellion/millenium_falcon
...
mv darth_vader star_wars/empire
